          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="nissan3.php" method="post" enctype="multipart/form-data">
                  <!-- <h1 class="text-center">เพิ่มข้อมูลสมาชิก</h1> -->

                  <label for="imgcar" class="form-label">รูปรถ</label>
                  <input type="file" class="form-control mb-3" name="imgcar2" required>

                  <label for="namecar" class="form-label">ยี่ห้อรถ</label>
                  <input type="text" class="form-control mb-3" name="namecar2" autofocus required>

                  <label for="idcar" class="form-label">ราคา</label>
                  <input type="text" class="form-control mb-3" name="idcar2" required>
        ...
        <table class="table table table-bordered border-dark">
          ...
          <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
              ...
              <td>
                <img src="upload4/<?php echo $row['b_img']; ?>" class="rounded-circle" style="width: 10vh; height: auto;">
              </td>

              <td><?php echo $row['b_carname']; ?></td>
              <td><?php echo $row['b_idcar']; ?></td>


              <td>
                <a class="btn btn-warning text-white w-50 mb-2" href="Register_edit.php?id=<?php echo $row['b_id']; ?>">แก้ไขข้อมูล</a> <br>
                <a class="btn btn-danger text-white w-50" href="member_del_.php?id=<?php echo $row['b_id']; ?>">ลบ</a>
              </td>
