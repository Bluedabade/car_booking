          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="mg3.php" method="post" enctype="multipart/form-data">
                  <!-- <h1 class="text-center">เพิ่มข้อมูลสมาชิก</h1> -->

                  <label for="imgcar" class="form-label">รูปรถ</label>
                  <input type="file" class="form-control mb-3" name="imgcar3" required>

                  <label for="namecar" class="form-label">ยี่ห้อรถ</label>
                  <input type="text" class="form-control mb-3" name="namecar3" autofocus required>

                  <label for="idcar" class="form-label">ราคา</label>
                  <input type="text" class="form-control mb-3" name="idcar3" required>
        ...
        <table class="table table table-bordered border-dark">
          ...
          <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
              ...
              <td>
                <img src="upload3/<?php echo $row['n_img']; ?>" class="rounded-circle" style="width: 10vh; height: auto;">
              </td>

              <td><?php echo $row['n_namecar']; ?></td>
              <td><?php echo $row['n_idcar']; ?></td>


              <td>
                <a class="btn btn-warning text-white w-50 mb-2" href="Register_edit.php=<?php echo $row['n_id']; ?>">แก้ไขข้อมูล</a> <br>
                <a class='btn btn-danger text-white w-50' href="delete.php?id=<?php echo $row['n_id']; ?>">ลบ</a>
              </td>
